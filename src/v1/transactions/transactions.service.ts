...
export class TransactionsService {
  ...
  async createDeposit(createDepositDto: CreateDepositDto): Promise<TransactionDocument> {
    ...
    const transaction = new this.transactionModel({
      ...
      initiatorId: new Types.ObjectId(createDepositDto.initiatorId),
      recipientId: new Types.ObjectId(createDepositDto.recipientId),
      productId: new Types.ObjectId(createDepositDto.productId),
      originSiteId: new Types.ObjectId(createDepositDto.originSiteId),
      destinationSiteId: new Types.ObjectId(createDepositDto.destinationSiteId),
      quantity: createDepositDto.quantity,
      unitPrice: createDepositDto.unitPrice || null,
      detentaire: new Types.ObjectId(createDepositDto.recipientId),
      ayant_droit: new Types.ObjectId(createDepositDto.initiatorId),
      isActive: true,
    });
